...
Функция А_ТабличныйДокументКарточкиНоменклатуры(Номенклатура, НастройкиВидимостиИЗаголовков, ДляПечати)
...
#Вставка
// Если Новинка, то есть Дата создания меньше 30 дней назад, то макет из расширения, иначе типовой
	Если ТекущаяДата() - Номенклатура.ДатаСоздания < 24*60*60*30 Тогда
		Макет = ПолучитьМакет("А_Новинка_ПФ_MXL_КарточкаНоменклатуры"); //Справочники.Номенклатура.
	Иначе
